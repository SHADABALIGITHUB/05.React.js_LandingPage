...
const CardLink = () => {
    return (
        <div className="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-black dark:border-gray-700">
    ...
    <NavLink
     ...
     onClick={()=>alert("working on this part")} >
      ...
      <div className="text-left rtl:text-right">
        <div className="mb-1 text-xs">Download APP</div>
